...
if not st.session_state.setup_complete:
    ...
    with col2:
        st.session_state["position"] = st.selectbox(
            "Choose a position",
            ("Data Scientist", "Data Engineer", "ML Engineer", "BI Analyst","Software Engineer", "Financial Analyst"),
            index=("Data Scientist", "Data Engineer", "ML Engineer", "BI Analyst","Software Engineer", "Financial Analyst").index(st.session_state["position"])
        )
